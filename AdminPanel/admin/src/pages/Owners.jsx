...
function Owners() {
  ...
  const updateOwnerStatus = async (phone, newStatus, reason = "") => {
    ...
    try {
      ...
      setOwners((prev) =>
        prev.map((owner) =>
          owner.phone.toLowerCase() === cleanEmail
  ...
  const handleApproveConfirm = async () => {
    ...
    const ownerEmail = approvingOwner.phone;
    setShowApproveModal(false);
    setApprovingOwner(null);

    const ok = await updateOwnerStatus(ownerEmail, "active");
    if (ok) {
  ...
  const handleSuspendSubmit = async () => {
    ...
    const ownerEmail = suspendingOwner.phone;
  ...
  return (
    <div className="dashboard">
      ...
      <div className="main" style={{ padding: 0 }}>
                      ...
                      >
                        ...
                        <td style={{ ...tdStyle, textAlign: "right" }}>
                          ...
                          >
                            ...
                            <button
                              style={viewBtn}
                              onClick={() => setSelectedEmail(owner.phone)}
                              title="View Details"
                            >
                              <FaEye size={16} />
                            </button>
        ...
        <OwnerDetailsModal phone={selectedEmail} onClose={closeModal} />
