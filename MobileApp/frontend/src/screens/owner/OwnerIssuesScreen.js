  ...
  const filteredIssues = issues
    .filter((item) => {
      ...
      const matchesSearch =
        ...
        (item.floor_no || "").toLowerCase().includes(searchLower) ||
        (item.room_no || "").toLowerCase().includes(searchLower) ||
            ...
            <TouchableOpacity onPress={() => openDetails(item)}>
              <View style={styles.card}>
                ...
                <Text style={styles.sub}>
                  {item.tenant_name} • Floor: {(item.floor_no && item.floor_no !== "N/A" && item.floor_no !== "None") ? item.floor_no : "-"} • Room: {(item.room_no && item.room_no !== "N/A" && item.room_no !== "None") ? item.room_no : "-"}
                </Text>
          ...
          <View style={{ flex: 1, backgroundColor: COLORS.BACKGROUND }}>
            ...
            <ScrollView style={styles.modal}>
              ...
              <View style={styles.detailCard}>
                ...
                <Detail label="Floor Number" value={(selectedIssue.floor_no && selectedIssue.floor_no !== "N/A" && selectedIssue.floor_no !== "None") ? selectedIssue.floor_no : "-"} />
                <Detail label="Room Number" value={(selectedIssue.room_no && selectedIssue.room_no !== "N/A" && selectedIssue.room_no !== "None") ? selectedIssue.room_no : "-"} />
