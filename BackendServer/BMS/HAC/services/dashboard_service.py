...
class DashboardService:
    ...
    def get_owner_dashboard_summary(owner):
        ...
        hostel_t = TenantBeds.objects.filter(Q(owner_phone__iexact=owner_id) | Q(owner_phone__iexact=owner_phone)).values_list('phone', flat=True)
        apt_t = ApartmentTenantBeds.objects.filter(Q(owner_phone__iexact=owner_id) | Q(owner_phone__iexact=owner_phone)).values_list('phone', flat=True)
        comm_t = CommercialTenantBeds.objects.filter(Q(owner_phone__iexact=owner_id) | Q(owner_phone__iexact=owner_phone)).values_list('phone', flat=True)
        ...
        pending_payments = Payment.objects.filter(
            Q(owner_phone__iexact=owner_id) | Q(owner_phone__iexact=owner_phone),
